...
/**
 * RIL customization for Galaxy Grand 2 Duos SM-G7102
 *
 * {@hide}
 */
public class G2RIL extends RIL {
    ...
    public G2RIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
